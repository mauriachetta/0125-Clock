...
// let nombreDiaSemana = nombresDiasSemana[fecha.getDay()];
...
function setClock(){
    ...
    let hora = fecha.getHours() < 10 ? "0" + fecha.getHours() : fecha.getHours() ; // condicion ? verdadero : falso
...
//     console.log("Che pasaron 3 segundos más... ")
